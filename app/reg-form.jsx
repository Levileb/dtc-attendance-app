...
import { View, Text, Image, StyleSheet, Dimensions, TouchableOpacity, ScrollView, SafeAreaView, Platform, StatusBar, TextInput } from 'react-native';
                    ...
                    <View style={styles.body}>
                        ...
                        <View style={styles.pickerContainer}>
                            <View style={[styles.inputContainer, { paddingHorizontal: 10 }]}>
                                <MaterialIcons name="work" size={22} color="#888" style={{ marginRight: 0 }} />
                                <View style={[styles.pickerWrapper, { flex: 1 }]}>
                                    ...
                                    >
                                        {sector === '' && (
                                            <Picker.Item label="Sector" value="" color="#888" enabled={false} />
                                        )}
                        ...
                        <View style={styles.pickerContainer}>
                            <View style={[styles.inputContainer, { paddingHorizontal: 10 }]}>
                                <MaterialIcons name="wc" size={22} color="#888" style={{ marginRight: 0 }} />
                                <View style={[styles.pickerWrapper, { flex: 1 }]}>
                                    <Picker
                                    ...
                                    >
                                        {gender === '' && (
                                            <Picker.Item label="Gender" value="" color="#888" enabled={false} />
                                        )}
